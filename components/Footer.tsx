...
const Footer = () => {
  return (
    <div className="flex flex-col items-center border-t-2 border-black bg-white pb-[1rem] dark:bg-black md:px-[9rem] lg:flex-row lg:justify-between lg:py-[2.5rem] xl:px-[22.5rem]">
